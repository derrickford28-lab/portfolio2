      ...
      <div className="container mx-auto px-3 md:px-10">
        <div className="px-5 py-32">
          ...
          <p className="font-circular-web max-w-md text-lg text-blue-50 opacity-50">
            A showcase of website concepts, UI designs, and interactive digital experiences.
          </p>
        </div>
        ...
        <BentoTilt className="border-hsla relative mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65vh]">
          <BentoCard
            ...
            title={
              <>
                Business <b>W</b>ebsite
              </>
            }
            description="Modern business website focused on branding and conversions."
          />
        </BentoTilt>
        ...
        >
          <BentoTilt className="bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2">
            <BentoCard
              ...
              description="Online store experience with responsive design."
            />
          </BentoTilt>
          ...
          <BentoTilt className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
            <BentoCard
              ...
              description="Personal branding and portfolio showcase."
            />
          </BentoTilt>
